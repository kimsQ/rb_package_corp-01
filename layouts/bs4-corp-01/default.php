...
<body class="rb-layout-default">
	...
	<header class="navbar fixed-top navbar-expand-lg navbar-light border-bottom bg-white">
	...
	?>
	<div class="jumbotron"  <?php if ($_HM['upload']): ?>style="background-image: url('<?php echo getPreviewResize($Topimg_URL,'1920x720')?>')"<?php endif; ?>>
		<div class="container">
			<h2>
	...
	<div class="container px-0 py-3">
		<main role="main" class="content rb-article">
